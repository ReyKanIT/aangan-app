...
const APK_URL = '/Aangan-v0.7.0.apk';
          ...
          <FadeIn delay={100}>
            <div className="flex justify-center mb-8">
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-4 min-h-dadi rounded-2xl bg-[#25D366] text-white font-semibold text-lg hover:bg-[#1DA851] transition-colors shadow-lg shadow-[#25D366]/25"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
